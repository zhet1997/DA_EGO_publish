function [y1,y2] = DynamicAgregate(func_dim,interaction,sensitive)
...
for ii = 1:size(ind2,1)
    ...
    temp2 = ind2(ii,2);
    temp1 = playerIndex(2,temp1);% which subplayer the varibale in.
    temp2 = playerIndex(2,temp2);
    if size(subsetPlayer{1,temp1},2) + size(subsetPlayer{1,temp2},2)>5
    ...
    if size(NomList,2)>func_dim/5+1 || order2(ii,1)<0.001
        break;
    end
end
y1 =  subsetPlayer;
